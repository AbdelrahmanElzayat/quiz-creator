...
const QuizCard = (props) => {
  ...
  const { data } = props;
  return (
    <div className={`quizCard ${props.class}`}>
      <div className="quizHeader">
        ...
        <div className="QuizRight">
          <div className="QuizOptions">
            <Link to={`/edit-quiz/${data?.id}`} title="edit">
              <svg
                width={24}
                height={24}
                xmlns="http://www.w3.org/2000/svg"
          ...
          {path.pathname !== "/" && data?.score && (
            <div className="QuizScore">
              <span>Final Score:</span> {data?.score}
            </div>
          )}
        </div>
      </div>
